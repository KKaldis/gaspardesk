...
const animation = () => {
  ...
  item1.from("#anim-item-1", 0, { delay: 0, ease: "Power1.easeInOut" });
  ...
  item1.to("#anim-item-9", 0, { delay: 1, display: "none" });
  ...
  item1.to("#anim-item-11", 0, { delay: 1.5, ease: "Power1.easeInOut" });
};
